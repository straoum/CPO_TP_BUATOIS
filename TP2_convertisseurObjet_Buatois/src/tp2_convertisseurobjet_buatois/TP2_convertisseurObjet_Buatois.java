...
public class TP2_convertisseurObjet_Buatois {
    ...
    public static void main(String[] args) {
        ...
        Scanner sc = new Scanner(System.in); //demande à l'utilisateur quelle conversion il veut faire
        System.out.println("Quelles conversion voulez-vous faire: 1: Celsius-->Kelvin \n 2: Kelvin-->Celsius \n 3: Farenheit-->Celsius \n 4: Celsius-->Farenheit \n 5: Kelvin-->Farenheit \n 6: Farenheit-->Kelvin");
        int a = sc.nextInt();
        double temp = 1.0; //choix de la température par défaut à 1.0 unité

        if (a == 1) { //choix d'une conversion de degrés Celsius vers Farenheit
        ...
        if (a == 2) { //choix d'une conversion de degrés Celsius vers Kelvin
