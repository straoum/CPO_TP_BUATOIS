...
public class TP2_Bieres_Buatois {
    ...
    public static void main(String[] args) { 
        ...
        BouteilleBiere autreBiere = new BouteilleBiere("Leffe", 6.6,    //création de nouvelles bières
                 "Abbaye de Leffe"); 
        ...
        autre1Biere.lireEtiquette(); //lecture de l'étiquette des différentes bières
        uneBiere.lireEtiquette();
        autreBiere.lireEtiquette();
        autre2Biere.lireEtiquette();
        autre3Biere.lireEtiquette();

        autre1Biere.Décapsuler();  //décapsulage de ces bières
        autre2Biere.Décapsuler();
        System.out.println(uneBiere) ;  //on demande si ces bières sont déjà ouvertes
